 ...
 */}
            <div className=" w-[400px] h-[400px] relative flex justify-center items-center rounded-full ">
                ...
                <div className="z-20 absolute -top-12 w-[400px] h-[370px] overflow-hidden ">
                ...
                <img className=" aspect-square z-10 opacity-60  animate-twice animate-winggle animate-duration-500  absolute z-10" src="/frame-profile/2.png" alt="" />
