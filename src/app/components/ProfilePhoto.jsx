export default function ProfilePhoto() {
    ...
    return (
        <div className="relative w-[200px] sm:w-[300px] xl:w-[500px] aspect-square rounded-full overflow-hidde">
            <img className="opacity-60 origin-bottom animate-twice animate-spin animate-duration-500 absolute top-0 z-" src="/frame-profile/circle1T.png" alt="" />

            <img className="opacity-60 origin-top animate-twice animate-spin animate-duration-500  absolute bottom-0 z-10" src="/frame-profile/circle1B.png" alt="" />
