...
export default function Footer() {
    ...
    const footerStyle = `font-light text-[1rem] w-[100vw] bg-primary10 backdrop-blur-xl text-customWhite ${open ? "h-100 md:h-40 py-4" : "h-5"}  flex flex-col items-center justify-end shadow-[0px_0px_15px_rgba(0,0,0,0.3)] px-8  duration-150 z-50 rounded-t-lg`
