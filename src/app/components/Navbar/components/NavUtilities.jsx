...
export default function NavUtilities({ navItems, handleActiveIndex, activeIndex }) {
    ...
    return (
        <>
            ...
            <div className={`flex flex-col justify-between duration-200 bg-customBlack90 absolute top-[40px] md:top-[64px] w-2/3 -right-0 shadow-lg  md:w-1/3  ${!toggleMenu && "-right-full"} h-[calc(100vh-32px)] md:h-[calc(100vh-64px)] px-6 py-10 text-secondary`}
