...
export default function Hero() {
    return (
        <div className=" text-customWhite relative h-[100vh] lg:max-h-[70vh] flex justify-center items-center uppercase  text-xl sm:text-3xl text-center">
            ...
            <div className="absolute flex flex-col gap-4 items-center [&>*]:px-4 sm:[&>*]:px-10 md:[&>*]:my-5">
                <h2 className="font-regular z-40 drop-shadow-md">
                    Potenciamos la ventana con la que tu marca saldrá al mundo,<br />
